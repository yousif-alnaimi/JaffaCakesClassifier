...
# random forest model
model2 = RandomForestClassifier(n_estimators=100, random_state=0, criterion='gini', bootstrap=True, oob_score=True)
...
# SVM model
model6 = svm.SVC(C=1, cache_size=1000)
...
y_pred4 = pred_model4.predict(X_test)
print("KNN", classification_report(y_test, y_pred4, labels=["biscuit", "cake"]),
